...
benchmarks/corpus/cases/ai-agent-mcp/indirect-output-001/agent-policy.json
benchmarks/corpus/cases/ai-agent-mcp/indirect-output-001/case.json
benchmarks/corpus/cases/ai-agent-mcp/indirect-output-control-001/agent-policy.json
benchmarks/corpus/cases/ai-agent-mcp/indirect-output-control-001/case.json
...
benchmarks/corpus/cases/dependency-supply-chain/dependency-control-001/case.json
benchmarks/corpus/cases/dependency-supply-chain/dependency-control-001/dependency-graph.json
...
benchmarks/corpus/cases/execution-boundaries/query-001/case.json
benchmarks/corpus/cases/execution-boundaries/query-001/query-policy.json
benchmarks/corpus/cases/execution-boundaries/query-control-001/case.json
benchmarks/corpus/cases/execution-boundaries/query-control-001/query-policy.json
benchmarks/corpus/cases/github-actions/cache-control-001/case.json
benchmarks/corpus/cases/github-actions/cache-control-001/workflow-fixture.yml
benchmarks/corpus/cases/github-actions/cache-target-001/case.json
benchmarks/corpus/cases/github-actions/cache-target-001/workflow-fixture.yml
...
benchmarks/corpus/cases/python-web/path-control-001/case.json
benchmarks/corpus/cases/python-web/path-control-001/file_helper.py
benchmarks/corpus/cases/secrets-logging/request-log-001/case.json
benchmarks/corpus/cases/secrets-logging/request-log-001/logging-policy.json
benchmarks/corpus/cases/secrets-logging/request-log-control-001/case.json
benchmarks/corpus/cases/secrets-logging/request-log-control-001/logging-policy.json
benchmarks/corpus/cases/webhook-trust/signature-001/case.json
benchmarks/corpus/cases/webhook-trust/signature-001/webhook-policy.json
benchmarks/corpus/cases/webhook-trust/signature-control-001/case.json
benchmarks/corpus/cases/webhook-trust/signature-control-001/webhook-policy.json
...
docs/releases/V0_5_0_PUBLICATION_HANDOFF.md
...
docs/dogfood/ITDO_ERP4_SECOND_DOGFOOD_SUMMARY.md
...
docs/evaluation/CLAIM_EVIDENCE_MATRIX.md
docs/evaluation/EVALUATION_REPRODUCTION.md
