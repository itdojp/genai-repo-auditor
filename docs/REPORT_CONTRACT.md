...
validation reports, Issue publication plan entries, workflow profile stages, and
metrics when those artifacts exist. Missing optional artifacts are recorded in
