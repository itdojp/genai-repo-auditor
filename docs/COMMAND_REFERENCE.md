...
gra-remediate --run runs/OWNER__REPO/RUN_ID --finding SEC-001 --validate --sandbox-profile local-test --build-command "python3 -m py_compile repo/app.py"
```
