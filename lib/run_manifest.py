...
def latest_status_paths(run_dir: Path) -> set[str]:
    return {
        ...
        reports_artifact(run_dir, "issue-dry-run-summary.json"),
        reports_artifact(run_dir, "ISSUE_DRY_RUN_SUMMARY.md"),
        reports_artifact(run_dir, "run-state.json"),
        reports_artifact(run_dir, "report-freshness.json"),
        reports_artifact(run_dir, "store-import-state.json"),
...
def collect_artifacts(run_dir: Path) -> list[dict[str, Any]]:
    candidates = [
        ...
        ("issue-dry-run-summary.schema.json", "file"),
        ("report-freshness.schema.json", "file"),
        ("store-import-state.schema.json", "file"),
        ...
        (reports_artifact(run_dir, "issue-dry-run-summary.json"), "file"),
        (reports_artifact(run_dir, "ISSUE_DRY_RUN_SUMMARY.md"), "file"),
        (reports_artifact(run_dir, "duplicate-decisions"), "dir"),
        (reports_artifact(run_dir, "run-state.json"), "file"),
        (reports_artifact(run_dir, "report-freshness.json"), "file"),
        (reports_artifact(run_dir, "store-import-state.json"), "file"),
...
def collect_schemas(run_dir: Path) -> list[dict[str, str]]:
    ...
    for name in [
        ...
        "traces.schema.json",
        "metrics.schema.json",
        "issue-dry-run-summary.schema.json",
        "report-freshness.schema.json",
        "store-import-state.schema.json",
